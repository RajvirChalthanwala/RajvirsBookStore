...
using RajvirsBooks.Models.ViewModels;
...
namespace RajvirsBooks.Ares.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        {
            return View(new RajvirsBookStore.Models.ViewModels.ErrorViewModel { RequestId = Activity.Current?.Id ?? HttpContext.TraceIdentifier });
        }
    }
}
